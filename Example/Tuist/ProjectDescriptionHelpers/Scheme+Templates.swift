...
public extension Scheme {
	static func debug(for target: String, packages: [String] = [], executable: String? = nil) -> Scheme {
		scheme(for: .debug, target: target, packages: packages, executable: executable)
	}

	static func release(for target: String, packages: [String] = [], executable: String? = nil) -> Scheme {
		scheme(for: .release, target: target, packages: packages, executable: executable)
	}

	static func beta(for target: String, packages: [String] = [], executable: String? = nil) -> Scheme {
	...
	static func allSchemes(for targets: [String], packages: [String] = [], executable: String? = nil) -> [Scheme] {
